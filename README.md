...
:-------------------------:|:--------------:|:-----------:
 ...
 Outlier Plotting and Removal | Custom Mapstyle |
 Clustering and Labeling | Aesthetic Consistency |
 Tesco Location Scraping and Plotting | Various Plot Factories |
 ...
 Correlation & Regression Analysis | Website |
